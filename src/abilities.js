...
export const ABILITIES = [
  {
    ...
    color: '#e8e2d2',
    text: p => `A hard chop: ${p} damage to whatever is in front of you.`,
  },
  {
    id: 'hvirvelvind', name: 'Whirlwind',
    cooldown: 9, stamina: 14, kind: 'aoe',
    power: 1.1, range: 4,
    color: '#bfe3ff',
    text: p => `Spin and hit everything within 4 m for ${p} damage.`,
  },
  {
    id: 'stormlob', name: 'Charge',
    cooldown: 8, stamina: 18, kind: 'charge',
    power: 1.3, range: 3.0, dash: 6,
    color: '#ffd479',
    text: p => `Rush 6 m forward, shoving and dealing ${p} damage on the way.`,
  },
  {
    id: 'forbinding', name: 'Field Dressing',
    cooldown: 24, stamina: 0, kind: 'heal',
    power: 0.3,
    color: '#7ce87c',
    text: p => `Bind your wounds: ${p} life back.`,
  },
  {
    id: 'stenhud', name: 'Stoneskin',
    cooldown: 30, stamina: 0, kind: 'buff', buff: 'shield', duration: 7,
    power: 0.36, cap: 80,
    color: '#a8b6c4',
    text: p => `Your skin turns to stone: ${p}% less damage for 7 seconds.`,
  },
  {
    id: 'ildstod', name: 'Firebolt',
    cooldown: 10, stamina: 20, kind: 'bolt',
    power: 1.7, range: 11,
    color: '#ff8a3c',
    text: p => `Hurl fire at an enemy up to 11 m away for ${p} damage.`,
  },
  {
    id: 'kampraseri', name: 'Battle Fury',
    cooldown: 40, stamina: 0, kind: 'buff', buff: 'rage', duration: 6,
    power: 0.3, cap: 60,
    color: '#ff5a5a',
    text: p => `Go berserk: ${p}% more damage for 6 seconds.`,
  },
  {
    id: 'dommedag', name: 'Doomfall',
    cooldown: 30, stamina: 30, kind: 'aoe',
    power: 1.6, range: 7,
    color: '#c07bff',
    text: p => `Break the ground apart: ${p} damage to everything within 7 m.`,
  },
];
